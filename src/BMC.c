...
void encode_bmc()
{
 ...
 {
   if (line_sequence[2*i-1]=ONE_MINUS_LEVEL) line_sequence[2*i] = ONE_PLUS_LEVEL; else line_sequence[2*i] = ONE_MINUS_LEVEL;
   ...
   {               
    case '1': 
               ...
               break;              
    case '0':
               line_sequence[2*i+1]=line_sequence[2*i];
               break;             
   };  
