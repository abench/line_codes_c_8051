...
xdata static unsigned int  line_sequence[SEQUENCE_LEN*2] = {ONE_MINUS_LEVEL,ONE_PLUS_LEVEL,ONE_MINUS_LEVEL,ONE_PLUS_LEVEL,ONE_MINUS_LEVEL,ONE_PLUS_LEVEL,ONE_MINUS_LEVEL,ONE_PLUS_LEVEL,
                                                            ONE_MINUS_LEVEL,ONE_PLUS_LEVEL,ONE_MINUS_LEVEL,ONE_PLUS_LEVEL,ONE_MINUS_LEVEL,ONE_PLUS_LEVEL,ONE_MINUS_LEVEL,ONE_PLUS_LEVEL,
                                                            ONE_MINUS_LEVEL,ONE_PLUS_LEVEL,ONE_MINUS_LEVEL,ONE_PLUS_LEVEL,ONE_MINUS_LEVEL,ONE_PLUS_LEVEL,ONE_MINUS_LEVEL,ONE_PLUS_LEVEL,
                                                            ONE_MINUS_LEVEL,ONE_PLUS_LEVEL,ONE_MINUS_LEVEL,ONE_PLUS_LEVEL,ONE_MINUS_LEVEL,ONE_PLUS_LEVEL,ONE_MINUS_LEVEL,ONE_PLUS_LEVEL};
...
void display_welcome_screen()
{
  LCD_CMD = (CLEAR_CMD);	
  delay16(300);
  string_to_hd(0,0,"BIPOLAR");
  string_to_hd(0,1,"NRZ CODE");
...
void encode_bipolar_nrz()
{
 unsigned int i ;             // counter
 unsigned int y = ZERO_LEVEL; // temporary value
