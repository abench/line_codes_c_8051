...
xdata static unsigned int  line_sequence[SEQUENCE_LEN*2] = {ZERO_LEVEL,ONE_PLUS_LEVEL,ZERO_LEVEL,ONE_PLUS_LEVEL,ZERO_LEVEL,ONE_PLUS_LEVEL,ZERO_LEVEL,ONE_PLUS_LEVEL,
                                                            ZERO_LEVEL,ONE_PLUS_LEVEL,ZERO_LEVEL,ONE_PLUS_LEVEL,ZERO_LEVEL,ONE_PLUS_LEVEL,ZERO_LEVEL,ONE_PLUS_LEVEL,
                                                            ZERO_LEVEL,ONE_PLUS_LEVEL,ZERO_LEVEL,ONE_PLUS_LEVEL,ZERO_LEVEL,ONE_PLUS_LEVEL,ZERO_LEVEL,ONE_PLUS_LEVEL,
                                                            ZERO_LEVEL,ONE_PLUS_LEVEL,ZERO_LEVEL,ONE_PLUS_LEVEL,ZERO_LEVEL,ONE_PLUS_LEVEL,ZERO_LEVEL,ONE_PLUS_LEVEL};
