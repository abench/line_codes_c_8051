 ...
 for (i=0;i<SEQUENCE_LEN;i++)
 {
   ...
   {               
    ...
    case '0':
               ...
               if (znum<4)
                   {
                      line_sequence[2*i]=ZERO_LEVEL;
                      line_sequence[2*i+1]=ZERO_LEVEL;
                   }
               else
                   {
                     // change 4 zero on pulse sequence according substitude table
                     //
                     //  last     pulse number
                     //  pulse    odd     even
                     //    -      000-    +00+
                     ...
                     switch (y)
                     {
                       case ONE_MINUS_LEVEL:
                                             if ((pnum%2)==0)
                                                 {
                                                   // even pulse number
                                                   line_sequence[2*(i-3)]=ONE_PLUS_LEVEL;
                                                   line_sequence[2*(i-3)+1]=ZERO_LEVEL;
                                                   
                                                   line_sequence[2*(i-2)]=ZERO_LEVEL;
                                                   line_sequence[2*(i-2)+1]=ZERO_LEVEL;
                                                   
                                                   line_sequence[2*(i-1)]=ZERO_LEVEL;
                                                   line_sequence[2*(i-1)+1]=ZERO_LEVEL;
                                                   
                                                   
                                                   line_sequence[2*i]=ONE_PLUS_LEVEL;
                                                   line_sequence[2*i+1]=ZERO_LEVEL;
                                                 ...
                                                 {
                                                   // odd pulse number
                                                   line_sequence[2*(i-3)]=ZERO_LEVEL;
                                                   line_sequence[2*(i-3)+1]=ZERO_LEVEL;
                                                   ...
                                                   line_sequence[2*i]=ONE_MINUS_LEVEL;
                                                   line_sequence[2*i+1]=ZERO_LEVEL;
                       ...
                       case ONE_PLUS_LEVEL:
                                             ...
                                             if ((pnum%2)==0)
                                                 {
                                                   // even pulse number
                                                   line_sequence[2*(i-3)]=ONE_MINUS_LEVEL;
                                                   line_sequence[2*(i-3)+1]=ZERO_LEVEL;
